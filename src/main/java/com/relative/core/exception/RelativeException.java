package com.relative.core.exception;
...
public class RelativeException extends Exception {
     ...
     */
    public RelativeException(String mensaje) {
        super(mensaje);
        this.mensaje = mensaje;
        insertarError();
    }

    public RelativeException(String mensaje, String detalle) {
    	super(detalle);
    	this.mensaje = mensaje;
