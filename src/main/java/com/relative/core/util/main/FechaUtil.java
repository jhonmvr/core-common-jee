...
public class FechaUtil {
	 ...
	 */
    public static String obtnerHoraMinutoComoCadena(Date fecha) throws RelativeException {
  		try {
  			...
  			throw new RelativeException("ERROR EN CONVERSION DE FECHA A FORMATO HH:MI " + e.getMessage());
  		}      
    }
}
