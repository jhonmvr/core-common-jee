...
public class ManagePropertiesFile {
	 ...
	 * @throws Exception 
	 */
	public static void saveProperties( Map<String,String> properties, String fileName, String pathName ) throws RelativeException{
		try {
			...
			throw new RelativeException(Constantes.ERROR_CODE_CUSTOM, "ERROR EN CARGA DEL ARCHIVO DE PROPIEDADES " + e.getMessage());
		}
	}
	 ...
	 * @throws Exception
	 */
	public static Map<String,String> convertPropertiesToMap( String fileName, String pathName ) throws RelativeException{
		try {
			...
			throw new RelativeException(Constantes.ERROR_CODE_CUSTOM, "ERROR EN CARGA DEL ARCHIVO DE PROPIEDADES Y CONVERSION A MAP " + e.getMessage());
		}
	}
	 ...
	 * @throws Exception
	 */
	public static Properties loadProperties( String fileName, String pathName ) throws RelativeException{
		...
		try {
			...
			throw new RelativeException(Constantes.ERROR_CODE_CUSTOM,"ERROR EN CARGA DEL ARCHIVO DE PROPIEDADES PATH " + pathName + " " + fileName +" " + e.getMessage());
		}
	}
	 ...
	 * @throws Exception
	 */
	public static void writeProperties( Properties prop,String fileName, String comments, String pathPropFile  ) throws RelativeException{
		try {
			FileOutputStream out =null;
			...
			throw new RelativeException(Constantes.ERROR_CODE_CUSTOM,"ERROR LA ESCRITURA DE PROPIEDADES PATH " + pathPropFile + " " + fileName +" " + e.getMessage());
		} 
	}
