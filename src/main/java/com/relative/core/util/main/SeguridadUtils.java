...
public class SeguridadUtils {
	...
	public static void main(String args[]) {
		try {
			System.out.println( generatePassword("q-preproduccion-email") );
	 ...
	 */
	public static String generatePassword(String password) throws RelativeException{
	 ...
	 */
	public static String getSecurePassword(String passwordToHash, byte[] salt) throws RelativeException
    {
        ...
        try {
        	...
        	throw new RelativeException(Constantes.ERROR_CODE_CUSTOM, "ERROR EN LA GENERACION DE SECURE PASSWORD");
        }
	 ...
	 */
	private static byte[] getSalt() throws RelativeException
    {
        try {
        	return Constantes.SECURITY_SALT.getBytes();
		} catch (Exception e) {
			throw new RelativeException(Constantes.ERROR_CODE_CUSTOM, "ERROR EN LA GENERACION DE SALT PARA PASSWORD");
		}
    }
    
    public static String generateMD5HashFromString(String toHash) throws RelativeException{
      try{
        ...
        MessageDigest md = MessageDigest.getInstance("MD5");
				...
				throw new RelativeException(Constantes.ERROR_CODE_CUSTOM, "ERROR UnsupportedEncodingException EN LA GENERACION DE HASH MD5");
			} catch (NoSuchAlgorithmException e) {
			   throw new RelativeException(Constantes.ERROR_CODE_CUSTOM, "ERROR NoSuchAlgorithmException EN LA GENERACION DE HASH MD5");
			}
    }
