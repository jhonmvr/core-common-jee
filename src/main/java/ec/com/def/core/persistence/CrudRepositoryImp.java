...
public abstract class CrudRepositoryImp<K, E> extends ReadRepositoryImp implements CrudRepository<K, E> {
    ...
    System.out.println("===inicio persiste");
      ...
      System.out.println("===termino persiste");
			...
			throw new DefException(Constantes.ERROR_CODE_CREATE, "ERROR EN LA CREACION DE " + entity.getClass().getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
	...
	public void add(Iterable<E> entities) throws DefException{
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_CREATE, "ERROR EN LA CREACION DE add batch"  + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
	...
	public E update(E entity) throws DefException {
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_UPDATE, "ERROR EN LA ACTUALIZACION DE " + entity.getClass().getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
	...
	public void remove(E entity) throws DefException {
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_DELETE, "ERROR EN LA ELIMINACION DE "
	...
	public E findById(K id) throws DefException {
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_READ, "ERROR EN LA BUSQUEDA POR ID DE " + entityClass.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
	 ...
	 */
	@Override
	public List<E> findAll(Class<E> c) throws DefException {
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_READ, "Constantes.PERSISTENCEEXCEPTION" + Constantes.MSG_ERROR_BUSQUEDA + c.getClass().getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		} catch (Exception e) {
			log.log(Level.SEVERE, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName(), e);
			throw new DefException(Constantes.ERROR_CODE_READ, Constantes.MSG_ERROR_BUSQUEDA + c.getClass().getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
	...
	public List<E> findAll(Class<E> c, String order, String direction) throws DefException {
		try {
			...
			log.log(Level.SEVERE, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName(), e);
			throw new DefException(Constantes.ERROR_CODE_READ,	"IllegalArgumentException " + Constantes.MSG_ERROR_BUSQUEDA + c.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		} catch (LockTimeoutException e) {
			log.log(Level.SEVERE, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName(), e);
			throw new DefException(Constantes.ERROR_CODE_READ,	Constantes.MSG_ERROR_BUSQUEDA + Constantes.MSG_ERROR_BUSQUEDA + c.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		} catch (QueryTimeoutException e) {
			log.log(Level.SEVERE, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName(), e);
			throw new DefException(Constantes.ERROR_CODE_READ,	Constantes.QUERYTIMEOUTEXCEPTION + Constantes.MSG_ERROR_BUSQUEDA + c.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		} catch (TransactionRequiredException e) {
			log.log(Level.SEVERE, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName(), e);
			throw new DefException(Constantes.ERROR_CODE_READ,	Constantes.TRANSACTIONREQUIREDEXCEPTION + Constantes.MSG_ERROR_BUSQUEDA + c.getName() + Constantes.MSG_CON_ERROR
							+ e.getMessage());
		} catch (PessimisticLockException e) {
			log.log(Level.SEVERE, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName(), e);
			throw new DefException(Constantes.ERROR_CODE_READ,	Constantes.PESSIMISTICLOCKEXCEPTION + Constantes.MSG_ERROR_BUSQUEDA + c.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		} catch (PersistenceException e) {
			log.log(Level.SEVERE, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName(), e);
			throw new DefException(Constantes.ERROR_CODE_READ,	Constantes.PERSISTENCEEXCEPTION + Constantes.MSG_ERROR_BUSQUEDA + c.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		} catch (Exception e) {
			log.log(Level.SEVERE, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName(), e);
			throw new DefException(Constantes.ERROR_CODE_READ, Constantes.MSG_ERROR_BUSQUEDA + c.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
	...
	public List<E> findAll(Class<E> c, int firstResult, int maxResults, String order, String direction)
		...
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_READ,	Constantes.TRANSACTIONREQUIREDEXCEPTION + Constantes.MSG_ERROR_BUSQUEDA + c.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		} catch (PessimisticLockException e) {
			...
			throw new DefException(Constantes.ERROR_CODE_READ, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName() + " " + e.getMessage());
		}
	}
	 ...
	 */
	@Override
	public Long countAll(Class<E> c) throws DefException {
		try {
			CriteriaBuilder qb = getEntityManager().getCriteriaBuilder();
