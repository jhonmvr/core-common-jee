...
public abstract class ReadRepositoryImp {
	 ...
	 * @throws DefException
	 */
	public <E> List<E> getObjectsByQuery(String consulta, Map<String, Object> parametros, Class<E> entityClass) throws DefException {
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_READ, Constantes.MSG_ERROR_BUSQUEDA + entityClass.getName() + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
	...
	public int ejecutarUpdate(String namedUpdateQuery, Map<String, Object> parametros) throws DefException {
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_READ, Constantes.MSG_ERROR_EJECUCION + namedUpdateQuery + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
	...
	public List<Object> ejecutarQueryNativo(String strQuery, Map<Integer, Object> parametros) throws DefException {
		try {
			...
			throw new DefException(Constantes.ERROR_CODE_READ, Constantes.MSG_ERROR_EJECUCION + strQuery + Constantes.MSG_CON_ERROR + e.getMessage());
		}
	}
